...
function calcular() {
    ...
    if (frmIMC.txtIdade.value === "") {
        ...
        //variaveis locais para capturar o conteudo
        ...
        if (document.getElementById("m").checked === true) {
            tmb = (66 + (13.7 * peso) + (altura * 100) - (6.8 * idade)) * opcaoValor
        }
        //fórmula para mulheres
        if (document.getElementById("f").checked === true) {
            tmb = (655 + (9.6 * peso) + (1.8 * altura) - (4.7 * idade )) * opcaoValor
        }
        //resultado final
